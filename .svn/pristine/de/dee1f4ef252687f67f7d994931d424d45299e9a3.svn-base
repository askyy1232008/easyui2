...
function stts(repayobj){
  var nowdate = $('#repay-form #paydate').datebox('getValue');
  if(repayobj !=null){
  ...
  var latefee = 0;
  var startday = 5; //每月开始计算滞纳金的日子
  var payday = parseInt(nowdate.split('-')[2]);
