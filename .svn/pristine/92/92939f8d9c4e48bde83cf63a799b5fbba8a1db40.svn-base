...
var span=$("<span class=\"textbox\">"+"<input class=\"textbox-text\" autocomplete=\"on\">"+"<input type=\"hidden\" autocomplete=\"on\" class=\"textbox-value\">"+"</span>").insertAfter(_4e1);
...
if(opts.multiline){
$("<textarea id=\""+_4e5+"\" class=\"textbox-text\" autocomplete=\"on\"></textarea>").prependTo(tb);
}else{
$("<input id=\""+_4e5+"\" type=\""+opts.type+"\" class=\"textbox-text\" autocomplete=\"on\">").prependTo(tb);
}
